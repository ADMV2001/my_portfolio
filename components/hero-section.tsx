import { Download, Mail, MapPin, Eye } from "lucide-react"
...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-6 bg-black">
      <div className="pt-20 lg:pt-9 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="bg-gradient-to-b from-black to-gray-900 rounded-[35px] p-12 w-full max-w-2xl">
          <div className="space-y-8">
            {/* Avatar and Info */}
            <div className="flex flex-col items-center text-center space-y-4 ">
              <div className="w-32 h-32 bg-black rounded-full border-2 border-black overflow-hidden">
                <Image
                  src="/profile-pic.jpg" // The path to your image in the public folder
                  alt="Minula Vihanga"
                  width={96} // Should match w-24 (24 * 4 = 96px)
                  height={96} // Should match h-24
                  className="object-cover w-full h-full"
                />
              </div>
              <div>
                <h2 className="text-4xl font-bold text-white">Minula Vihanga</h2>
                <p className="text-gray-400 text-l mt-2">Software Developer | AI Enthusiast</p>
              </div>
            </div>
        ...
        <div className="space-y-8 flex flex-col justify-center">
          ...
          <div className="font-mono text-lg ml-3 lg:ml-0">
           <p className="mt-2 text-sm sm:text-base leading-6 font-mono bg-black text-[#d4d4d4] p-4 rounded-lg shadow-lg overflow-x-auto">
          ...
          <div className="flex space-x-6 mt-4 ml-3 cursor-pointer justify-center lg:justify-start">
            ...
            <a
              ...
              className="transition-transform duration-300 hover:scale-115" 
            >
              <FaSquareGithub className="w-10 h-10 text-white" />
            </a>
            
            <a
              href="https://www.instagram.com/minula_v"
              target="_blank"
              rel="noopener noreferrer"
              className="transition-transform duration-300 hover:scale-115" 
            >
              <FaSquareInstagram className="w-10 h-10 text-white" />
            </a>

            <a
              href="https://www.facebook.com/share/19vF2UFrbY/"
              target="_blank"
              rel="noopener noreferrer"
              className="transition-transform duration-300 hover:scale-115" 
            >
            ...
            <a
              ...
              className="transition-transform duration-300 hover:scale-115" 
            >
              <ImMail className="w-10 h-10  text-white" />
            </a>
          </div>
